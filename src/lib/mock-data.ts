...
import type { Company, Contact, Message, Profile, Tier, Stage, Category, Role } from "@prisma/client";
...
const CONTACT_REQUESTED_1: ContactWithMessages = {
  ...
  name: "Priya Sharma",
  company: "Hopper",
  category: "STACK_MATCH" as Category,
...
const CONTACT_CONTACTED_1: ContactWithMessages = {
  ...
  messageMode: "CONNECTION_NOTE" as const,
...
const CONTACT_CONTACTED_2: ContactWithMessages = {
  ...
  name: "Marcus Chen",
  company: "Lightspeed",
  category: "RECRUITER_AGENCY" as Category,
  connectionState: "CONNECTED" as const,
  messageMode: "CONNECTION_NOTE" as const,
  stage: "CONTACTED" as Stage,
